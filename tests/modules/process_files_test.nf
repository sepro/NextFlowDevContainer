// Test version of PROCESS_FILES with shorter sleep time
process PROCESS_FILES {
    ...
    if [ -f "${file_path}" ]; then
        ...
        # Sleep for 1 second instead of 10 for faster testing
        echo "Sleeping for 1 second..." >> processed_${file_path.baseName}.log
        sleep 1
